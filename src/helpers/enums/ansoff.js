  ...
  switch (estrategia) {
    case Estrategia.PENETRACION:
      switch (true) {
        ...
        default:
          return 'Usted tiene un número bajo de productos penetrativos. El riesgo puede ser bajo, pero las oportunidades perdidas en su mercado actual, en el conoce a sus clientes, podrían ser muy altas.';
      }
    case Estrategia.DIVERSIFICAICON:
      switch (true) {
        ...
        case porcentaje > 25 && porcentaje < 30:
          return 'Usted tiene un número promedio de productos clasificados como diversificación. Esta es la posición en la que quiere estar, el riesgo está reducido pero las oportunidades de expansion son altas.';
        default:
    ...
    case Estrategia.DESARROLLO_DE_MERCADO:
      switch (true) {
        case porcentaje === 0:
          return 'Usted no tiene productos o servicios clasificados como desarrollo del mercado. Esto implica que se está perdiendo la oportunidad de llevar sus productos o servicios ya establecidos a nuevos mercados. Utilice lo que ya tiene!';
        case porcentaje > 30:
